    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Patient', 'Patient'), ('Doctor', 'Doctor'), ('Admin', 'Admin')], default='Patient', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospitalTreatmentSystem.appointment')),
                ('treatment', models.ManyToManyField(to='hospitalTreatmentSystem.treatment')),
            ],
        ),
    ]
